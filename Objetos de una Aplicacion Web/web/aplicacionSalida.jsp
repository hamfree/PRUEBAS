<%-- Documento: salidaAplicacion.jsp --%>
...
<title>Objeto application - recuperando valores</title>
<style type="text/css">
TD {
	border: 1px inset;
	padding: 2px;
...
<body style="font-family: monospace;">
	<h1 style="text-align: center;">Recuperando datos del objeto
		application</h1>
	<table style="width: 70%; margin: 0 auto; border: 1px inset;">
		...
		<tbody>
			<%
				Enumeration<String> atributos = application.getAttributeNames();
